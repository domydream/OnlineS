        ...
        <div class="row">          
            ...
            <div class="col-md-4 col-sm-6 col-xs-6">
                <div class="panel panel-back noti-box">
                    ...
                    <div class="text-box">
                        <p class="main-text"><asp:Label runat="server" ID="countMessage"> </asp:Label> News</p>
            ...
            <div class="col-md-4 col-sm-6 col-xs-6">
                <div class="panel panel-back noti-box">
                    ...
                    <div class="text-box">
                        <p class="main-text"><asp:Label ID="countSMSService" runat="server"></asp:Label> Free SMS </p>
